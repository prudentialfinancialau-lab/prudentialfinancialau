        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 md:bottom-8 md:left-8 md:right-8 bg-emerald-500 text-white p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                <p className="font-semibold text-xs sm:text-sm md:text-base">- John Doe, President</p>
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
              Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Praesent sapien massa, convallis a pellentesque nec, egestas non nisi. Vivamus suscipit tortor eget felis porttitor volutpat.
            </p>

            {/* Stats Grid */}
            <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-emerald-500 mb-1 sm:mb-2">20+</div>
                <p className="text-gray-700 font-medium text-xs sm:text-sm md:text-base">Years Of Experience</p>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-emerald-500 mb-1 sm:mb-2">90%</div>
                <p className="text-gray-700 font-medium text-xs sm:text-sm md:text-base">Customer Worldwide</p>
              </div>
            </div>
          </div>
        </div>
