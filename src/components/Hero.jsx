        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="flex items-center gap-3 mt-6 sm:mt-8">
              ...
              <span className="text-gray-700 font-medium text-sm sm:text-base">Join with Company</span>
            </div>
          ...
          <div className="bg-gray-800 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-2xl order-1 lg:order-2">
            <h3 className="text-white text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Calculate Your Mortgage</h3>
